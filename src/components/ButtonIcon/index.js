...
import {IconAddSaldo, IconGetPoint, IconKiloan, IconKarpet, IconSatuan, IconSetrika, IconEkspress, IconVIP} from '../../assets'
...
const styles = StyleSheet.create({
    ...
    text: (type) => ({
        ...
        fontFamily: type === "layanan" ? 'TittilliumWeb-Light' : 'TittilliumWeb-Regular',
        textAlign: 'center'
    })
})